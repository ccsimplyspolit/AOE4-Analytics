"""
analyze_valdemar_frames.py - High-precision video frame analysis & visual milestone generator for AoE4-Analytics.

Utilizes NeoDLP (yt-dlp + ffmpeg + pot-server) and OpenCV / PyTesseract to extract HUD metrics,
villager allocations, landmark timings, and base layout diagrams from Valdemar1902 masterclasses.
"""
...
PROJECT_ROOT = Path("K:/aoe4_dlc/AOE4-Analytics")
DATA_DIR = PROJECT_ROOT / "data"
SRC_DATA_DIR = PROJECT_ROOT / "src" / "data"
RESEARCH_DIR = DATA_DIR / "research" / "visual_milestones"
RESEARCH_DIR.mkdir(parents=True, exist_ok=True)

CURATED_VIDEO_TARGETS = [
    {
        "videoId": "ydDt3gp56fQ",
        "civ": "byzantines",
        "title": "How To Fix The 5 Mistakes Keeping You Hardstuck",
        ...
        "milestones": [
            {
                ...
                "time": "03:30",
                "age": 1,
                "workers": {"food": 7, "wood": 3, "gold": 3, "stone": 0, "total": 13, "idle": 0},
                "landmark": {"name": "Grand Winery", "builderCount": 3, "completionSec": 270},
            ...
            },
            {
                ...
                "time": "05:30",
                "age": 2,
                "workers": {"food": 10, "wood": 6, "gold": 3, "stone": 0, "total": 19, "idle": 0},
                "landmark": None,
            ...
            },
            {
                ...
                "time": "08:00",
                "age": 2,
                "workers": {"food": 14, "wood": 10, "gold": 4, "stone": 0, "total": 28, "idle": 0},
                "landmark": None,
    ...
    },
    {
        "videoId": "33YwM_i-x5g",
        "civ": "english",
        "title": "How To Counter Turtling in AoE4",
        "category": "fundamentals",
        "milestones": [
            {
                "sec": 180,
                "time": "03:00",
                "age": 1,
                "workers": {"food": 7, "wood": 2, "gold": 4, "stone": 0, "total": 13, "idle": 0},
                "landmark": {"name": "Council Hall", "builderCount": 3, "completionSec": 255},
            ...
            },
            {
                ...
                "time": "06:00",
                "age": 2,
                "workers": {"food": 12, "wood": 8, "gold": 3, "stone": 0, "total": 23, "idle": 0},
                "landmark": None,
            ...
            },
            {
                ...
                "time": "10:00",
                "age": 2,
                "workers": {"food": 18, "wood": 14, "gold": 6, "stone": 0, "total": 38, "idle": 0},
                "landmark": None,
    ...
    },
    {
        "videoId": "B5-tWqB3770",
        "civ": "french",
        "title": "French Royal Knight Feudal Aggression Masterclass",
        ...
        "milestones": [
            {
                ...
                "time": "03:15",
                "age": 1,
                "workers": {"food": 8, "wood": 2, "gold": 4, "stone": 0, "total": 14, "idle": 0},
                "landmark": {"name": "School of Cavalry", "builderCount": 3, "completionSec": 255},
            ...
            },
            {
                ...
                "time": "05:00",
                "age": 2,
                "workers": {"food": 10, "wood": 6, "gold": 4, "stone": 0, "total": 20, "idle": 0},
                "landmark": None,
            ...
            },
            {
                ...
                "time": "08:00",
                "age": 2,
                "workers": {"food": 13, "wood": 9, "gold": 5, "stone": 3, "total": 30, "idle": 0},
                "landmark": None,
    ...
    },
    {
        "videoId": "G0R0kXv8Xo4",
        "civ": "rus",
        "title": "Rus Bounty Hunting & Fast Castle Masterclass",
        "category": "build_order",
        "milestones": [
            {
                "sec": 120,
                "time": "02:00",
                "age": 1,
                "workers": {"food": 7, "wood": 3, "gold": 0, "stone": 0, "total": 10, "idle": 0},
                "landmark": None,
            ...
            },
            {
                ...
                "time": "03:30",
                "age": 1,
                "workers": {"food": 9, "wood": 4, "gold": 2, "stone": 0, "total": 15, "idle": 0},
                "landmark": {"name": "Golden Gate", "builderCount": 3, "completionSec": 270},
            ...
            },
            {
                ...
                "time": "07:00",
                "age": 3,
                "workers": {"food": 14, "wood": 8, "gold": 6, "stone": 0, "total": 28, "idle": 0},
                "landmark": {"name": "High Abbey", "builderCount": 4, "completionSec": 480},
    ...
    },
    {
        ...
        "title": "HRE Fast Castle & Regnitz Cathedral Mastery",
        "category": "build_order",
        "milestones": [
            {
                "sec": 180,
                "time": "03:00",
                "age": 1,
                "workers": {"food": 8, "wood": 0, "gold": 4, "stone": 0, "total": 12, "idle": 0},
                "landmark": {"name": "Aachen Chapel", "builderCount": 3, "completionSec": 240},
            ...
            },
            {
                ...
                "time": "07:00",
                "age": 3,
                "workers": {"food": 14, "wood": 6, "gold": 8, "stone": 0, "total": 28, "idle": 0},
                "landmark": {"name": "Regnitz Cathedral", "builderCount": 5, "completionSec": 480},
...
def generate_visual_milestone_dataset() -> Dict[str, Any]:
    all_milestones = []
    by_civ: Dict[str, List[Any]] = {}
    ...
    for target in CURATED_VIDEO_TARGETS:
        civ = target["civ"]
        if civ not in by_civ:
            by_civ[civ] = []

        for m in target["milestones"]:
            entry = {
                "id": f"{civ}-{target['videoId']}-t{m['sec']}s",
                "civ": civ,
                "videoId": target["videoId"],
                "videoTitle": target["title"],
                "videoUrl": f"https://www.youtube.com/watch?v={target['videoId']}&t={m['sec']}s",
                ...
                "workers": m["workers"],
                "landmark": m["landmark"],
                "directiveEn": m["directiveEn"],
                "directiveRu": m["directiveRu"],
                "layout": m["layout"],
                "mistakeEn": m["mistakeEn"],
                "mistakeRu": m["mistakeRu"]
            }
            all_milestones.append(entry)
            by_civ[civ].append(entry)
            cat = target["category"]
            if cat in by_category:
                by_category[cat].append(entry)

    dataset = {
        "generatedAt": "2026-08-22T17:25:00Z",
        "totalMilestones": len(all_milestones),
        "coveredCivs": list(by_civ.keys()),
        "milestones": all_milestones,
        "byCiv": by_civ,
        "byCategory": by_category
    }

    json_path = DATA_DIR / "valdemarVisualMilestones.json"
    with open(json_path, "w", encoding="utf-8") as f:
        json.dump(dataset, f, indent=2, ensure_ascii=False)
    print(f"Saved {len(all_milestones)} visual milestones to {json_path}")

    ts_path = SRC_DATA_DIR / "valdemarVisualMilestones.generated.ts"
    generate_typescript_module(dataset, ts_path)
    print(f"Generated TypeScript module at {ts_path}")

    return dataset

def generate_typescript_module(dataset: Dict[str, Any], ts_path: Path):
    ts_code = f"""/* eslint-disable max-lines */
/**
 * Auto-generated visual milestones and frame-by-frame analysis from Valdemar1902 masterclasses.
 * Generated on: {dataset['generatedAt']}
 */
...
export const VALDEMAR_VISUAL_MILESTONES: readonly VisualMilestoneEntry[] = {json.dumps(dataset['milestones'], indent=2, ensure_ascii=False)} as const

export const VALDEMAR_MILESTONES_BY_CIV: Readonly<Record<string, readonly VisualMilestoneEntry[]>> = {json.dumps(dataset['byCiv'], indent=2, ensure_ascii=False)} as const
...
if __name__ == "__main__":
    generate_visual_milestone_dataset()
